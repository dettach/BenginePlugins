				...
				<tr>
					...
					<td class="control">
						...
						if(isset($v["child"]) and $v["child"] > 0) {
							...
							echo '<a href="/admin/catalog/delete/'.$v["id"].'/"><img src="/system/template/img/delete.png" /></a>';
						}
					echo '<a href="/admin/catalog/edit/'.$v["id"].'/"><img src="/system/template/img/reply.png" /></a>
					</td>
				</tr>
				';
				if(isset($v["child"]) and $v["child"] > 0) {
...
$(document).ready(function(){
	$(".click_menu").click(function(){
		...
		$.post("/admin/catalog/menu/"+rel+"/",function(data) {
...
<form action="#" method="post">
	<fieldset>
		<legend>Структура каталога:</legend>
	...
	<a href="/admin/catalog/add/" class="button">Создать новый каталог</a>
</form>