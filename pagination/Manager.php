...
class Krugozor_Pagination_Manager
{
    ...
    public function __construct($limit = 10, $link_count = 10, $request, $page_var_name = 'page', $separator_var_name = 'sep')
    {
        ...
        {
            $this->current_sep  = $request->getRequest($separator_var_name, 'decimal') ? false : 1;
            $this->current_page = $request->getRequest($page_var_name, 'decimal') ? false : ($this->current_sep - 1) * $this->link_count + 1;
        }
    ...
    {
        return $this->current_page - ($this->current_page % $this->link_count ? false : $this->link_count);
    }
