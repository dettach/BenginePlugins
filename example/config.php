...
# default (обязательно) - значение по умолчанию при установке или обновлении
...
# тогда заполняется поле default таким образом, чтобы показать, что это будет
# для номера это будет default => 0, а если заголовок, то default => "_поле_таблицы_"
